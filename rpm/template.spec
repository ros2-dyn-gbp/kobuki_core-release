...
%global pkg_name kobuki_core
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-kobuki-core
Version:        1.4.0
Release:        3%{?dist}
Summary:        ROS %{pkg_name} package

License:        BSD
URL:            https://kobuki.readthedocs.io/en/release-1.0.x/
...
%changelog
* Fri Mar 22 2024 Daniel Stonier <d.stonier@gmail.com> - 1.4.0-3
